...
const steps = [{
  ...
  showOn: function () {
    Object(_helpers_filterMethod__WEBPACK_IMPORTED_MODULE_0__["currentStepValidator"])('.js-onboardingWizard-load-methods', '.pushable');
    return !Object(_helpers_filterMethod__WEBPACK_IMPORTED_MODULE_0__["methodLoadIndicator"])('.js-payment-method-not-loaded');
  },
...
const methodLoadIndicator = item => {
  const indicatedItem = document.querySelector(item);
