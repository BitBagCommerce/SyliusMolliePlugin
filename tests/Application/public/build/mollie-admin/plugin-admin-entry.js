...
const steps = [{
  ...
  showOn: function () {
    (0,_helpers_filterMethod__WEBPACK_IMPORTED_MODULE_0__.updateTourCompletition)();
    return true;
  },
  id: 'save',
  text: 'stepSave.text',
...
/* harmony export */   "updateTourCompletition": () => (/* binding */ updateTourCompletition)
/* harmony export */ });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((steps = []) => steps.map(step => ({ ...step,
